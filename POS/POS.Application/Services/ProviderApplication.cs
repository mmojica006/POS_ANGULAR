...
namespace POS.Application.Services
{
    public class ProviderApplication : IProviderApplication
    {
        ...
        public ProviderApplication(IUnitOfWork unitOfWork, IMapper mapper, CategoryValidator validationRules, IOrderingQuery orderingQuery)
        {
        ...
        public async Task<BaseResponse<IEnumerable<ProviderResponseDto>>> ListProviders(BaseFilterRequest filters)
        {
            ...
            try
            {
                ...
                var items = await _orderingQuery.Ordering(filters, providers, !(bool)filters.Download!).ToListAsync(); //Devuelve el resultado ordenado y paginado
